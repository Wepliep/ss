const scenario = [
    {
        ...
        loseMessages: ["Paslı bıçakla zinciri kesmeye çalışırken bileğini kestin ve kan kaybından öldün.", "Kırık Ayna Parçasıyla kurtulmaya çalışırken bileğini kestin ve kan kaybından öldün.", "Eski anahtarla zinciri çözmeye çalıştığında, zincir kırıldı ve susuz kalarak öldün.", "Saç tokası ile zinciri çözmeye çalıştığında, zincir kırıldı ve susuz kalarak öldün."],
    },
    {
        ...
        loseMessages: ["Güneş sembolünü seçtin. Kapı açılmadı ve odanın tavanından zehirli gaz sızmaya başladı.", "Yıldız sembolünü seçtin. Kapı açılmadı ve odanın zemininden sivri kazıklar yükselmeye başladı.", "Su sembolünü seçtin. Kapı açılmadı ve odanın duvarlarından buz gibi sular akmaya başladı.", "Ateş sembolünü seçtin, ve tavandaki oklar üzerine yağmaya başladı."],
    },
    {
        ...
        loseMessages: ["13 numaralı kapıyı seçtin. Ancak odada seni bekleyen keskin bıçaklar var.", "17 numaralı kapıyı seçtin. Kapının arkasında asit dolu bir havuz var.", "21 numaralı kapıyı seçtin. Kapının arkasında alevlerle dolu bir oda var.", "37 numaralı kapıyı seçtin. Kapının arkasında seni parçalayacak dev bir dişli çark var."],
    },
    {
        ...
        loseMessages: ["Labirent bulmacasını çözmeye çalışırken labirentin duvarları hareket etti ve seni ezdi.", "Mantık bulmacası çözmeye çalışırken  odanın zemini kaymaya başladı ve seni aşağıya çekti.", "Matematik bulmacasını çözmeye çalışırken karşına  boğaziçiliden diferansiyel videosu çıktı.", "Ses bulmacasını çözmeye çalışırken odanın hoparlörlerinden yüksek frekanslı bir ses çıktı ve beynini parçaladı."],
    },
    {
        ...
        loseMessages: ["Işıkla aydınlatılmış yolu seçtin. Lazerler belirdi ve tüm ışınlar üzerine gelmeye başladı.","Su dolu yolu seçtin. Su seviyesi yükseldi ve seni boğdu.", "Alevli yolu seçtin. Alevler seni yaktı ve kül etti.", "Zehirli gazlı yolu seçtin. Zehirli gaz seni zehirledi ve öldürdü.", "Tuzaklı yolu seçtin. Tuzaklar seni parçaladı ve öldürdü."],
    },
        {
        ...
        loseMessages: ["Sağa döndün ve bir uçurumdan aşağı düştün.", "düz ilerledin ve tuzaklarla dolu bir odaya girdin.", "Yukarı tırmandın ve merdiven kırılarak karnına saplandı.", "Aşağı indin ve zehirli bir bataklığa saplandın."],
    },
        {
        ...
        loseMessages: ["Alev duvarını aşmaya çalışırken yandın.", "Lazerler Tuzakları devreye girdi ve seni kesti.", "Sivri kazıklara takıldın ve parçalandın.", "Zehirli dartlar seni zehirledi."],
    },
        {
        ...
        answer: ["Sarı Düğme"],
        loseOptions: ["Kırmızı Düğme", "Mavi Düğme", "Yeşil Düğme", "Sarı Düğme", "Mor Düğme"],
        loseMessages: ["Kırmızı düğmeye bastın ve kapı kilitlendi, odanın tavanından zehirli gaz sızmaya başladı.", "Mavi düğmeye bastın ve kapı kilitlendi, odanın zemini kaymaya başladı.", "Yeşil düğmeye bastın ve kapı kilitlendi, odanın duvarlarından alevler yükselmeye başladı.", "Mor düğmeye bastın ve kapı kilitlendi, odanın duvarları üzerine doğru gelmeye başladı."],
    },
        {
        ...
        loseMessages: ["Havalandırma bacasına girdin ve sıkışarak öldün.", "Gizli Geçite girdin ve balporsuğu tarafınfan öldürüldün.", "Asansör boşluğuna indin ve düşerek öldün.", "Tünele girdin ve tünel çöktü."],
    },
        {
        ...
        loseMessages: ["Dolaba saklandın ve Amanda seni buldu.", "Yatak altına saklandın ve Amanda seni buldu.", "Tavan arasına saklandın ve Amanda seni buldu.", "Kilere saklandın ve Amanda seni buldu."],
    },
        {
        ...
        loseMessages: ["Baltayı kullanmaya çalışırken kendine zarar verdin.", "Merdiveni kullanmaya çalışırken merdiven kırıldı ve düştün.", "Levyeyi kullanmaya çalıştığında oyuncak olduğunu fark ettin." ,"Çekici kullanmaya çalışırken çekicin sapı kırıldı ve sapı karnına saplandı."],
    },
        {
